...
Amber::Server.configure do |settings|
  ...
  #
  # settings.name = "Formee web application."
  #
  #
  ...
  #
  # settings.secret_key_base= Q8b5S8O5UMXnl0z7kAbTJflZySCM7j_DBYwPaZLHSFs
  #
  #
  ...
  #
  # settings.logger = Amber::Environment::Logger.new(File.open("formee.log", "w"))
  #
  #
end
